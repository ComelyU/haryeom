...
import { getTutoringVideo, getTutoringVideoList } from '@/apis/tutoring/get-tutoring-video';
...
const Review = () => {
    ...
    const test = async () => {
        // const data = await getTutoringVideoList(3);
        const data = await getTutoringVideo(36);
        console.log(data);
    };
    ...
    return (
        <HomeLayout>
            ...
            <button onClick={test}>비디오 목록</button>
        </HomeLayout>
    );
};
